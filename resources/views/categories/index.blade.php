<x-app-layout :title="'Categories ' . ' - ' . config('app.name')">
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                            ...
                            <nav>
                                <ul role="tablist"
                                    ...
                                    <li role="tab"
                                        ...
                                        data-value="all">
                                        <a href="{{ route('categories.index', ['sortByDate' => request('sortByDate') === 'asc' ? 'desc' : 'asc']) }}" class="z-20 text-inherit">
                                            &nbsp;&nbsp;Date&nbsp;&uarr;&darr;&nbsp;&nbsp;
                                        </a>
                                    ...
                                    <li role="tab"
                                        ...
                                        <a href="{{ route('categories.index', ['sortByName' => request('sortByName') === 'asc' ? 'desc' : 'asc']) }}" class="z-20 text-inherit">
                                            @php
                ...
                {{-- END TABLE --}}
                {{-- PAGINATION --}}
                <x-pagination :resource=$categories />
                {{-- END PAGINATION --}}
            </div>
        </div>
    </div>
