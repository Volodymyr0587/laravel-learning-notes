    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                        <thead class="bg-gray-100 text-left">
                            <tr>
                                <th
                                    class="whitespace-nowrap px-4 py-3 font-semibold text-gray-600 uppercase tracking-wider">
                                    Item Type
                                </th>
                                <th
                                    class="whitespace-nowrap px-4 py-3 font-semibold text-gray-600 uppercase tracking-wider">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr>
                                <td class="whitespace-nowrap px-4 py-4">
                                    <div class="flex items-center">
                                        <div class="h-3 w-3 rounded-full bg-blue-500 mr-3 shrink-0"></div>
                            ...
                            <tr>
                                <td class="whitespace-nowrap px-4 py-4">
                                    <div class="flex items-center">
                                        <div class="h-3 w-3 rounded-full bg-indigo-500 mr-3 shrink-0"></div>
                                        <span class="font-medium text-gray-900">Resource Types</span>
                                    </div>
                                </td>
                                <td class="whitespace-nowrap px-4 py-4 font-medium text-gray-700">
                                    {{ $resourceTypesCount }}
                            ...
                            <tr>
                                <td class="whitespace-nowrap px-4 py-4">
                                    <div class="flex items-center">
                                        <div class="h-3 w-3 rounded-full bg-purple-500 mr-3 shrink-0"></div>
                            ...
                            <tr>
                                <td class="whitespace-nowrap px-4 py-4">
                                    <div class="flex items-center">
                                        <div class="h-3 w-3 rounded-full bg-red-500 mr-3 shrink-0"></div>
                ...
                <div class="flex flex-col gap-2 p-6 text-gray-900 shrink-0 sm:flex-row">

                    <a href="{{ route('resource-types.create') }}"
                        class="flex select-none items-center gap-3 rounded-lg bg-gray-900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button">
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" stroke-width="2" class="w-4 h-4"
