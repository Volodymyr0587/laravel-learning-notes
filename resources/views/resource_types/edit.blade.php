<x-app-layout :title="'Edit: ' . $resourceType->name . ' - ' . config('app.name')">
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-10 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Notes in the {{  strtoupper($resourceType->name) }} resource type</h2>
                    {{-- TABLE --}}
                <div class="p-6 px-0 ">
                ...
                {{-- END TABLE --}}
                {{-- PAGINATION --}}
                <x-pagination :resource=$relatedNotes />
                {{-- END PAGINATION --}}
                </div>
            </div>
        </div>
