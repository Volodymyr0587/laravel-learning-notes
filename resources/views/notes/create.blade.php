                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="link_to_resource"
                                            class="block text-sm font-medium leading-6 text-gray-900">Link to the resource (website, youtube channel etc.)</label>
                                        <div class="mt-2">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <select id="resource_type" name="resource_type" autocomplete="resource_type"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                                @foreach (App\Enums\ResourceType::all() as $value => $label)
