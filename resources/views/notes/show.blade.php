                        ...
                        <div
                            ...
                            <div class="lg:pr-4">
                                <div class="lg:max-w-lg">
                                    ...
                                    <a class="group inline-flex items-center h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                        ...
                                        <span class="group-hover:opacity-100 transition-opacity bg-gray-800 px-1 text-sm text-gray-100 rounded-md absolute top-16 -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto">
                                            Edit note
                                        </span>
                                    </a>
                                    <a class="group inline-flex items-center h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                        ...
                                        <span class="group-hover:opacity-100 transition-opacity bg-gray-800 px-1 text-sm text-gray-100 rounded-md absolute top-16 left-80 ml-4 -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto">
                                            Export to text file
                                        </span>
                                    </a>
